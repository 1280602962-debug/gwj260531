...
1. 仓库内有 `SCREENING_SOP.md`（AF3 主 / Glide 辅）  
2. Layer1 种子列表 ≥200 SMILES（可先虚拟）  
3. 开题/报告中写入 Phase 0 对比一句结论 + claim boundary  
4. 列出 Top 想采购/合成的 5–10 个化学型方向（不必已有活性）  

完成以上四项，即可进入 **第一次真实缩库筛选**。
