...
See `data/jcim_bench_v0/CLAIM_CEILING.md` items 50–57, `analysis/CHEMBL_UNIVERSE_PAIR_CENSUS_V1.md`, `analysis/K4_UNIVERSE_SUITABILITY_V1.md`, and `analysis/UNIVERSE_STRUCTURE_FEASIBILITY_V1.md`.
