...
EGFR/HER2, AChE/BChE, and PIK3CA/mTOR now use the same ChEMBL 37 dump operations as the other five pairs. Full eight-pair parity is in `EIGHT_PAIR_DUMP_GATED_V1.md` and `eight_pair_dump_gated_v1/parity_v1.csv`.
