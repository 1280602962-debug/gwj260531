...
| PM110 GNINA（mode_01，历史值） | 0.522 [0.38, 0.66]（近随机） |
| PM110 GNINA（best-of-9，2026-08-24 公平重打后，当前值） | **0.613** [0.46, 0.74]（仍近随机，但高于 mode_01） |
...
4. 正文以 **Vina 口袋匹配** 作 PM 主报告；RTM/GNINA 作重打分对照（未增强，甚至更弱）。GNINA 已于 2026-08-24 补做全 9 姿态公平重打（`GNINA_POCKET_MATCHED_BEST9_VERDICT_V1.md`），PM110/PM48 引用值改用 best-of-9；mode_01 保留作历史对照，不再作为正文引用值。
