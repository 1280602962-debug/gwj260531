...
48. MCL1/Bcl-xL (Tables S50–S51, S53) was docked only as a predeclared **applicability stress-test** after the LC6 pose-gold gate failed. Allowed: map 82/77/24/122; panel 24/24/24/24; n_complete 93/96; 3WIY best-of-top3 1.689 Å (pass); 3WIZ best-of-top3 2.011 Å (fail); Vina `summary_min` 0.609 with Dual-versus-B-only CI including 0.5. Forbidden: fifth Table 2 pair; K expanded beyond 4; domain extension; target-general PPI screening performance; BindingDB AUROC. Table S52 is a literature comparator, not a bake-off.
