...
50. The ChEMBL 37 human SINGLE PROTEIN universe pair census (`data/jcim_chembl_universe_v0/`) is a **post-hoc dump-level supply enumeration**, not a replacement for Table S44’s frozen J0 49-pair list and not a docking expansion. Allowed: report how many unordered pairs in that dump meet the same θ = 6.0 / strict 6.5/5.5 gates as J0; name the dump version; cross-walk J0 and the 2026-07-29 fetch queue. Forbidden: “ChEMBL contains only 49 dual-target pairs”; treating universe passers as a new DualFourClass-Bench; docking those pairs; unfreezing Table 2 or K = 4 from these counts.
