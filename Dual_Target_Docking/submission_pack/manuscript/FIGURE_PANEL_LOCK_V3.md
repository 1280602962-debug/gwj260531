...
| 1 | C | ChEMBL universe census: 2,164,618 / 63,790 / 5,253 / 86 pairs. The eight-pair evaluation set is shown as a separate box, not as a fifth funnel step. | `universe_census_summary_v1.csv` |
