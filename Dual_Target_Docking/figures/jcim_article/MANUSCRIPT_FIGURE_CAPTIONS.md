...
(A) Activity-threshold grid. (B) Cluster resampling for EGFR/HER2 and JAK1/TYK2. EGFR cluster bootstrap was not recomputed after the canonical box correction.
