"""Archived unused v3 figure builders.

These functions are NOT the official artwork writer. They were removed from
plot_jcim_article_figures_v3.py so later agents do not call them to write
formal figures or plotted_values.json.

Official plotter: figures/jcim_article/scripts/update_figures_pr32.py
Official plotted values: figures/jcim_article/plotted_values_postfix.json

Load/helper functions remain in plot_jcim_article_figures_v3.py.
This file is provenance only and is not imported by the freeze chain.
"""
from __future__ import annotations

# Extracted from plot_jcim_article_figures_v3.py. Not wired to any entry point.

# --- fig1/fig2/fig3 leftover builders ---
