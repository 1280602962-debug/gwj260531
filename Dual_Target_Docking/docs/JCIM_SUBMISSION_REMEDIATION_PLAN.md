...
2. **Partially completed.** Top-1/top-3/all-deposited RMSD was topology-checked and recomputed for 4EY7, 4BDS, and 2WXF; deposited symmetry-aware results already give the corresponding ranks for 4L23 and 4JT6. 4BDS and 4JT6 fail at top-1 but pass within top-3. EGFR/HER2 cognate pose artifacts remain absent from git (`cognate_artifact_inventory_v1.csv`); recover or reconstruct locally. Best-of-nine remains a search-coverage rather than score-ranking check.
