...
> **红队复核与重设计（Stage M，优先）：** [`PLAN_V2_REDTEAM_AND_REDESIGN.md`](PLAN_V2_REDTEAM_AND_REDESIGN.md)  
> **现行第一步命令（Stage M）：** [`AGENT_COMMAND_STAGE_M.md`](AGENT_COMMAND_STAGE_M.md)  
> **STEP0 命令（Track A 启动包，Stage M 之后）：** [`AGENT_COMMAND_STEP0_TRACK_A_STARTER.md`](AGENT_COMMAND_STEP0_TRACK_A_STARTER.md)  
