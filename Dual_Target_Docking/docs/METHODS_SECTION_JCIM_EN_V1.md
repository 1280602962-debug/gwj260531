...
To test sensitivity of the benchmark conclusion to receptor choice, alternate crystals were required, **before scores were seen**, to (i) have a polymer entity that is the true target protein (no chimeras or off-target scaffolds), (ii) contain a small-molecule cognate in the ATP or target site, (iii) have acceptable resolution, and (iv) pass the same cognate redocking QC as Section 2.5. Structures actually docked were PIK3CA 4JPS and 5DXT and mTOR 4JSX. This is a **receptor-structure sensitivity analysis**. It does not certify a “more correct” crystal and does not treat PIK3CA/mTOR as a prespecified structure-invariant positive case.

Replacement was **one pocket at a time**: 4JPS/5DXT replaced pocket A (PIK3CA) while pocket B kept frozen 4JT6 scores; 4JSX replaced pocket B (mTOR) while pocket A kept frozen 4L23 scores. New boxes used that crystal’s own cognate ligand and the Section 2.4 AABB rule. Ligand preparation, exhaustiveness (16), seed (20260727), scoring function, and the primary endpoint matched the PM48 main analysis. Only PM48 ligands were redocked.
