...
In the evaluated four-pair Vina-based benchmark, DualFourClass-Bench showed that docking-based dual-target discrimination was pair-dependent, often no stronger than ligand-property or fingerprint baselines, and sensitive to receptor choice.
