...
|---|---|---|---|---|---|
| C1 | ZH/EN incremental |Δ| disagreed, and deposited ECFP CSV 0.0112 was not reproducible in the freeze environment. | Baseline ZH Discussion 0.023 vs EN 0.011; freeze rebuild + old `fit_ecfp4_models.py` on the identical master both give max \|Δ\| = 0.0234 at PPARA/PPARD D vs B (rdkit 2026.03.6, sklearn 1.9.1). Table 2 unchanged. | Manuscripts, SI Table S5, ECFP CSVs. | Accept the rebuilt 0.023; do not chase 0.0112. | EN/ZH/SI use 0.023 from freeze incremental; QA matches rebuilt max. |
