...
Apparent discrimination also depends on receptor realization. Holding one pocket frozen and replacing the other raised discrimination on one PIK3CA-related pair and lowered it on the other (Results 3.4; Figure 4B), consistent with kinase cross-docking work that treats receptor representation as a performance variable.[14]
