...
| MCL1 | 6UDV | alternate | 1.35 | A | — | — | 无可评分姿态；停止 |
| BCL2L1 | 3SP7 | alternate | 1.4 | A | — | — | 无可评分姿态；停止 |
...
## Table S54. 五种子 Vina 敏感性

来源：`data/jcim_multiseed_v0/tables/multiseed_auroc_aggregate_v1.csv`；逐种子结果见 `multiseed_auroc_by_seed_v1.csv`。生产种子 20260727 与额外冻结种子 20260811–20260814 使用相同配体、受体、盒子、exhaustiveness、九姿态和分析规则。主文 Tables 2–3 仍使用生产种子，不以多种子均值替换。

| 靶对 | `summary_min` 中位数 | 范围 | Dual-vs-neither 中位数 | 设定差值中位数 | 差值符号与主种子一致 |
|------|----------------------:|-----:|-----------------------:|-----------------:|:--------------------:|
| EGFR/HER2 | 0.373 | 0.321–0.430 | 0.769 | 0.402 | 5/5 |
| AChE/BChE | 0.599 | 0.553–0.606 | 0.649 | 0.060 | 5/5 |
| PIK3CA/PIK3CB | 0.478 | 0.468–0.502 | 0.593 | 0.119 | 5/5 |
| PIK3CA/mTOR | 0.704 | 0.676–0.726 | 0.535 | -0.164 | 5/5 |

这些重复支持冻结面板内设定差值方向的随机种子稳定性，不支持挑选有利种子或外推到其他靶对。
