...
| EGFR/HER2 | 严格 6.5/5.5 | 26 / 17 / 7 | 0.176 | [0.039, 0.346] |
...
| EGFR/HER2 | 口袋 B（对 A-only） | 0.661 | 0.738 | 0.077 | [−0.131, 0.269] | 否 |
| AChE/BChE | 口袋 A | 0.606 | 0.590 | −0.016 | [−0.149, 0.115] | 否 |
| AChE/BChE | 口袋 B | 0.652 | 0.709 | 0.056 | [−0.097, 0.193] | 否 |
...
|------|-----------------|-----------------------:|--:|--------|:-------------:|
| EGFR/HER2 | cLogP | 0.482 | −0.159 | [−0.304, 0.010] | 否 |
...
|------|------|--:|--------|:---------:|:-------------------:|
| EGFR/HER2 | 主集 | 0.056 | [−0.029, 0.157] | 否 | 否 |
...
|------|------|------|------------:|---------------------------|----------------:|
| EGFR/HER2 | Vina 主分析 | 28 / 38 / 32 / 12 | 0.324 [0.192, 0.463] | dual–B-only（口袋 A） 0.324 [0.192, 0.463] | 0.759 [0.554, 0.926] |
| EGFR/HER2 | GNINA 独立 | 28 / 38 / 32 / 11 | 0.265 [0.144, 0.401] | dual–B-only（口袋 A） 0.265 [0.144, 0.401] | 0.737 [0.529, 0.919] |
...
**Figure S4.** (A) 活性阈值敏感性；(B) EGFR/HER2 与 JAK1/TYK2 的簇重采样区间。EGFR/HER2 簇 bootstrap 已用校正盒评分和冻结的骨架/文献分组重算。该图不重复 Figure 4 的留出集口袋对调。
