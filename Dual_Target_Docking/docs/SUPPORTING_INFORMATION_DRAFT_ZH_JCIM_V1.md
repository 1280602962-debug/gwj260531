...
| 靶对 | n_ranked (D / A / B / N) | k | Top 10% D / A / B / N | dual / k | AND 输入 → 通过 (D / A / B) | AND dual precision |
|------|-------------------------:|--:|----------------------:|---------:|------------------------------:|-------------------:|
