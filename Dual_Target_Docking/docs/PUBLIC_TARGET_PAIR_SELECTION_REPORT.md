...
**明确不评为主公开对：** NLRP3 / JNK1（私有 holdout）。
...
| 靶点对 | holo PDB 粗计 (A/B, ≤3.5Å) | 独立二元对接 | 双端同配体共晶 | 文献双靶 | 相对 NLRP3/JNK1 |
|--------|----------------------------|--------------|----------------|----------|-----------------|
| PIK3CA / mTOR | 106 / 41 | ✓ 常规 | 本 catalog 无 | 大量经典双抑制（另有 PROTAC，需分表） | 不重合 |
| EGFR / HER2 | 343 / 28 | ✓ 激酶 ATP | **有** TAK-285 (3POZ/3RCD) | 大量双 TKI | 不重合 |
| Mcl-1 / Bcl-xL | 122 / 72 | ✓ 但 PPI 沟槽更难 | **有** LC6 (3WIY/3WIZ) | Tanaka JMC 等 | 不重合 |
| AChE / BChE | 74 / 108 | ✓ | 非本 catalog Tier A | 大量双胆碱酯酶 | 不重合 |
| BRD4 / HDAC* | 584 / 6(HDAC1) | HDAC=Zn **金属酶** | 多为仅 BRD4 端 | **100 篇最热** | 不重合 |
