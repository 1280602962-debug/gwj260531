...
|---|---:|---:|---:|---|
| PIK3CA/mTOR | 0.765 [0.603, 0.891] | 0.692 | +0.073 | point estimate above heavy 0.555 (Δ = +0.21) |
| AChE/BChE | 0.618 [0.422, 0.759] | 0.606 | +0.012 | point estimate slightly above cLogP 0.575 (Δ = +0.043); CI still includes 0.5 |
| PIK3CA/PIK3CB | 0.425 [0.241, 0.618] | 0.500 | −0.075 | point estimate below heavy 0.691 (Δ = −0.266) |
