...
A nested evaluation question follows from the same design: whether a conventional Dual-versus-inactive (or Dual-versus-neither) readout on the same scores would support a more optimistic interpretation than the directional hard-negative task.
