...
**C3 现行路线（实验结构模板上的双节点指纹筛选，候选优先）：** [`docs/PROJECT_ROUTE_C3_CRYOEM_DUAL_NODE.md`](docs/PROJECT_ROUTE_C3_CRYOEM_DUAL_NODE.md) · [`config/campaign_c3.yaml`](config/campaign_c3.yaml)  
...
| [**C3 实验结构双节点路线**](docs/PROJECT_ROUTE_C3_CRYOEM_DUAL_NODE.md) | **现行路线**：9DK 同构建体四联作 URAT1 模板（cryo-EM）、7ALV 作 NLRP3 模板（X-ray）、突变体校准 IFP、交叉对接矩阵、双池候选与 MD；「cryo-EM 锚定」不是方法名 |
