...
*图1 NLRP3开放八聚体（NLRP3ΔPYD/+ATP）的冷冻电镜结构，显示NACHT域铰链旋转及寡聚界面。改绘自Yu et al., *Nat Commun* 2024[2]。*

![图2 NLRP3激活机制模型（Yu et al., 2024, Nat Commun）[2]](./NLRP3_review_figures/fig5_activation_model.png)

*图2 NLRP3从关闭笼状结构经开放八聚体向活性盘状结构转变的激活模型。改绘自Yu et al., *Nat Commun* 2024[2]。*

![图3 活性NLRP3炎症小体盘状结构（Le et al., 2023, Nature）[3]](./NLRP3_review_figures/fig1_nlrp3_disc_nature.png)

*图3 活性NLRP3炎症小体盘状冷冻电镜结构。NLRP3 NACHT结构域在激活过程中发生约85°–90°旋转，FISNA结构域在稳定活性构象中发挥关键作用。改绘自Le et al., *Nature* 2023[3]。*
...
*图5 非活性、ADP结合的NLRP3十聚体与CRID3（MCC950）复合物结构示意。CRID3结合于NACHT域中央疏水口袋并桥接NACHT与LRR过渡区，将蛋白锁定于关闭构象（PDB: 7PZC；Hochheiser et al., *Nature* 2022[14]）。*
