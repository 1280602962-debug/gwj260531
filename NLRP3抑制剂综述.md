...
NLRP3抑制剂领域的基础研究与药物化学已相当深入，结构生物学揭示了从关闭笼状结构到活性盘状结构的完整构象转变路径，oxDNA通路与新型非磺酰脲骨架（如BGE-102）的涌现拓展了药物设计的边界；多个候选药物已进入II期临床，但尚无获批品种。未来2—3年II期数据读出和新型抑制模式的临床验证，将决定该领域能否完成从"有希望的靶点"到"可成药疗法"的关键跨越。
