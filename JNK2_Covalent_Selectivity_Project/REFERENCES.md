# JNK2 选择性共价抑制剂筛选 — 参考文献

本文件为 `JNK2选择性共价抑制剂筛选方案.md` 的完整参考文献列表，按主题分类。所有 DOI 已核对可解析。
...
Lu W, Liu Y, Gao Y, Geng Q, Gurbani D, Li L, et al. Development of a Covalent Inhibitor of c-Jun N-Terminal Protein Kinase (JNK) 2/3 with Selectivity over JNK1. *Journal of Medicinal Chemistry.* 2023;66(5):3356-3371.

- **DOI:** [10.1021/acs.jmedchem.2c01834](https://doi.org/10.1021/acs.jmedchem.2c01834)
- **PMID:** [36826833](https://pubmed.ncbi.nlm.nih.gov/36826833/)
- **PMC:** [PMC11190964](https://pmc.ncbi.nlm.nih.gov/articles/PMC11190964/)
- **关键内容:** YL5084 发现；Cys116 共价；kinact/KI JNK2/JNK1 ≈ 21×；8ELC/7N8T 共晶；Leu106/Ile106 选择性机制；500 ns MD

### [R2] JNK-IN-8 — Pan-JNK 共价起点
...
### [R3] JNK2–YL2056 共价共晶（主对接模板）

Li L, Gurbani D, Westover KD, et al. Human JNK2 bound to covalent inhibitor YL2056. PDB **8ELC**.

- **PDB DOI:** [10.2210/pdb8elc/pdb](https://doi.org/10.2210/pdb8elc/pdb)
- **RCSB:** [https://www.rcsb.org/structure/8ELC](https://www.rcsb.org/structure/8ELC)
- **Released:** 2023-06-28 | **Resolution:** 2.0 Å | **Primary citation:** [R1]

### [R4] JNK2–AMP

PDB **7N8T**. *Primary citation:* [R1]

- **PDB DOI:** [10.2210/pdb7n8t/pdb](https://doi.org/10.2210/pdb7n8t/pdb)
- **Resolution:** 1.6 Å

### [R5] JNK3–JNK-IN-8 共价

PDB **3V6R**. *Primary citation:* [R2]

- **PDB DOI:** [10.2210/pdb3v6r/pdb](https://doi.org/10.2210/pdb3v6r/pdb)
- **Resolution:** 2.97 Å

### [R6] JNK2–indazole 35F（非共价，交叉验证）

Shaw D, Auld DS, et al. J Mol Biol. 2008;383(4):885-893. PDB **3E7O**.
...
### [R8] JNK1 vs JNK2 功能拮抗

Liu J, Lin A. Role of JNK activation in apoptosis: a double-edged sword. *Journal of Biological Chemistry.* 2005;280(22):21453-21456.

- **DOI:** [10.1074/jbc.R500018200](https://doi.org/10.1074/jbc.R500018200)

### [R9] JNK 抑制剂综述（Perspective）

Wang Y, et al. Unraveling the Design and Discovery of c-Jun N-Terminal Kinase Inhibitors and Their Therapeutic Potential in Human Diseases. *Journal of Medicinal Chemistry.* 2022;65(11):7531-7562.

- **DOI:** [10.1021/acs.jmedchem.1c01947](https://doi.org/10.1021/acs.jmedchem.1c01947)

### [R10] JNK2/3 氨基吡唑亚型选择性（Leu144/Ile106）

Park H, Iqbal S, Hernandez P, et al. Structural Basis and Biological Consequences for JNK2/3 Isoform Selective Aminopyrazoles. *Scientific Reports.* 2015;5:8047.

- **DOI:** [10.1038/srep08047](https://doi.org/10.1038/srep08047)

### [R11] SP600125（pan-JNK 工具化合物，历史参照）

Bennett BL, Sasaki DT, Murray BW, O'Leary EC, Sakata ST, Xu W, et al. SP600125, an anthrapyrazolone inhibitor of Jun N-terminal kinase. *Proceedings of the National Academy of Sciences.* 2001;98(24):13681-13686.

- **DOI:** [10.1073/pnas.251194298](https://doi.org/10.1073/pnas.251194298)

---

## 四、可逆 JNK 对照化合物

### [R12] CC-930（Tanzisertib）

Plantevin Krenitsky V, et al. Discovery of CC-930, an orally active anti-fibrotic JNK inhibitor. *Bioorganic & Medicinal Chemistry Letters.* 2012;22(3):1433-1438.

- **DOI:** [10.1016/j.bmcl.2011.12.010](https://doi.org/10.1016/j.bmcl.2011.12.010)
- **PMID:** [22244937](https://pubmed.ncbi.nlm.nih.gov/22244937/)
- **Note:** 可逆 pan-JNK；Ki 5–61 nM 各亚型；Phase II IPF 后终止
...
Boike L, Nomura DK, Cravatt BF. Advances in covalent drug discovery. *Nature Reviews Drug Discovery.* 2022;21(12):881-898.

- **DOI:** [10.1038/s41573-022-00516-z](https://doi.org/10.1038/s41573-022-00516-z)

### [R14] 激酶共价 TCI 综述

Singh J, Petter RC, Kluge AF. Targeted covalent drugs of the kinase family. *Current Opinion in Chemical Biology.* 2010;14(4):475-480.

- **DOI:** [10.1016/j.cbpa.2010.06.177](https://doi.org/10.1016/j.cbpa.2010.06.177)

### [R15] AF3 共价虚筛（BTK / COValid）

Shamir Y, Gabizon R, Rogel A, Lin DYW, Andreotti AH, London N. Discovery of Covalent Ligands with AlphaFold3. *Journal of the American Chemical Society.* 2026;148(12):13043-13054.

- **DOI:** [10.1021/jacs.5c22222](https://doi.org/10.1021/jacs.5c22222)
- **PMID:** [41857796](https://pubmed.ncbi.nlm.nih.gov/41857796/)
- **关键内容:** COValid 基准；mPAE 排序；BTK Cys481 906K 前瞻性筛库
...
### [R17] JNK1 非共价选择性项目报告 v2.8

`JNK1_Selectivity_Project/docs/JNK1_PROJECT_REPORT.md`  
分支: `origin/cursor/purchase-list-md-05df`

- **关键结论:** Δsel / pass_selectivity 不能用于选择性采购；JNK2 sole receptor 3E7O

### [R18] JNK 非共价 IFP/MM-GBSA 工作流

`jnk_docking_export/WORKFLOW_STEP1_STEP2.md`  
分支: `origin/cursor/jnk-step1-step2-workflow-cd8a`

- **Note:** 排除 JNK-IN-8；非共价 benchmark 专用

### [R19] NLRP3 共价 AF3 难度报告（AF3 gate 警示）

`NLRP3_共价抑制剂筛选难度分析报告.md`  
分支: `origin/cursor/nlrp3-covalent-difficulty-analysis-26c6`

- **关联:** 强调 Phase 0 阳性对照校准必要性
